...
import { MessageCircle, HelpCircle, Calendar, ShieldCheck, Zap } from 'lucide-react';
...
const CTA = () => {
  return (
    <section id="contacto" className="bg-estetia-primary py-24 sm:py-32">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 text-left sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
            {actionItems.map((item) => (
              <div key={item.title} className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-3xl p-8 flex flex-col">
          ...
          <div className="mt-16">
            <a 
              ...
              className="inline-flex items-center justify-center rounded-full bg-green-500 px-10 py-4 text-base font-semibold text-white shadow-lg transition-transform duration-300 hover:scale-105 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300"
            >
